...
(defcomponent project-page (project related-posts)
    :styles
  (concatenate
   'list
   (top-level-css)
      ...
      (with-accessors ((name project-name)
        ...
        (:section.container
         ...
         (:article.main
          ...
          (render oracle-nav-component :spec oracle-spec :realm "#oracle-realm")
          ...
          (:div#oracle-realm
           ...
           (:div#explore
            ...
            (render posts-listing-component :posts related-posts))))
