...
Browser. More functionality on top of it is provided with [[id:7c11ffa6-701d-48a0-ac3c-b839fd210951][apps]]. Different apps need to be configured
as documented in [[id:7c11ffa6-701d-48a0-ac3c-b839fd210951][apps]] section below.
...
1. *Load the apps you want to use*
   ...
   ready to be loaded with a call to =require=. For example, to load =spookfox-org-tabs= app, you'd
   write this Elisp:
...
2. *Tell spookfox which apps you want to enable*
   ...
   #+begin_src elisp :eval never-export
     (setq spookfox-enabled-apps (list spookfox-org-tabs))
   #+end_src
